...
st.set_page_config(
    page_title="Business Data Explorer",
    page_icon="🔎",
    layout="wide",
)

st.title("Browse business data")
st.caption(
    "Search the imported Brighton business records. This is a reference view for "
    "prospecting and checking a record; reports are created from the report console."
)
if st.session_state.get(ACTIVE_REPORT_PROJECT_KEY):
    st.info("A report project is active. Browse freely, then return to continue it.")
