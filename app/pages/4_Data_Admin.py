...
from src.report_generator_readiness import ACTIVE_REPORT_PROJECT_KEY, REPORT_SEARCH_KEY
...
if st.session_state.get(ACTIVE_REPORT_PROJECT_KEY) or st.session_state.get(REPORT_SEARCH_KEY):
